...
enum parameters {ELEMENT_LENGTH,T_UNKNOWN,k_UNKNOWN,LAMBDA_UNKNOWN,EPSILON_UNKNOWN,W_UNKNOWN,ALPHA__UNKNOWN,DELTA_UNKNOWN,N_UNKNOWN};
...
class mesh{
    ...
    public:
        void setParameters(float L,float T,float K,float LAMBDA,float EPSILON,float W,float ALPHA,float DELTA,float N){
            parameters[ELEMENT_LENGTH]=L;
            parameters[T_UNKNOWN]=T;
            parameters[k_UNKNOWN]=K;
            parameters[LAMBDA_UNKNOWN]=LAMBDA;
            parameters[EPSILON_UNKNOWN]=EPSILON;
            parameters[W_UNKNOWN]=W;
            parameters[ALPHA__UNKNOWN]=ALPHA;
            parameters[DELTA_UNKNOWN]=DELTA;
